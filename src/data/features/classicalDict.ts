...
export const CLASSICAL_DICT: DictEntry[] = [
  ...
  { word: '丞相', classicalMeaning: '最高行政长官', modernEquivalent: '宰相/总理', example: '丞相祠堂何处寻', source: '杜甫《蜀相》', allusion: '秦汉最高官职，明太祖废丞相后不复设' },
  { word: '御史', classicalMeaning: '监察官员', modernEquivalent: '监察官/纪检', example: '御史中丞', source: '《汉书》', allusion: '御史台为古代监察机构，负责弹劾百官' },
  { word: '刺史', classicalMeaning: '中央派驻地方的监察官', modernEquivalent: '省长/州长官', example: '刺史察举', source: '《后汉书》', allusion: '汉武帝创刺史制度，后演变为地方行政长官' },
  { word: '太守', classicalMeaning: '一郡长官', modernEquivalent: '市长/地级市长', example: '太守迎客', source: '《后汉书》', allusion: '汉代郡级最高行政长官，秩二千石' },
  { word: '尚书', classicalMeaning: '皇帝近臣→六部首长', modernEquivalent: '部长', example: '吏部尚书', source: '《汉书》', allusion: '由文书官演变为主管六部的堂官，明清为正二品' },
  { word: '稽首', classicalMeaning: '跪拜触地，最重礼', modernEquivalent: '磕头/跪拜', example: '稽首再拜', source: '《尚书》', allusion: '九拜之首，臣对君之礼' },
  { word: '顿首', classicalMeaning: '叩头触地即起', modernEquivalent: '叩头', example: '顿首再拜', source: '《左传》', allusion: '九拜之一，平辈间礼节，较稽首轻' },
  { word: '万福', classicalMeaning: '女性行礼祝辞', modernEquivalent: '问好（女性用）', example: '道个万福', source: '《红楼梦》', allusion: '唐宋后女性常用见面礼，双手合抱胸前' },
  { word: '麾', classicalMeaning: '将帅旗帜/指挥', modernEquivalent: '军旗/指挥', example: '麾下', source: '《史记》', allusion: '麾即将帅军旗，"麾下"指将帅部下' },
  { word: '烽', classicalMeaning: '边境报警烟火', modernEquivalent: '烽火/警报', example: '烽火连三月', source: '杜甫《春望》', allusion: '烽火台白天燃烟为烽，夜间举火为燧' },
  { word: '戍', classicalMeaning: '驻守边疆', modernEquivalent: '驻防/守卫', example: '戍鼓断人行', source: '杜甫《月夜忆舍弟》', allusion: '戍卒为边防士兵，秦汉徭役含戍边' },
  { word: '馔', classicalMeaning: '食物/菜肴', modernEquivalent: '饭菜/美食', example: '盛馔', source: '《论语》', allusion: '"馔"指精美食物，盛馔即丰盛的菜肴' },
  { word: '觞', classicalMeaning: '酒器/敬酒', modernEquivalent: '酒杯/举杯', example: '飞觞醉月', source: '李白《春夜宴从弟桃花园序》', allusion: '觞为古代酒器，曲水流觞为文人雅集' },
  { word: '朔', classicalMeaning: '农历每月初一', modernEquivalent: '初一', example: '朔望之礼', source: '《尚书》', allusion: '朔为月初，望为月圆（十五），晦为月末' },
  { word: '望', classicalMeaning: '农历每月十五', modernEquivalent: '十五/满月', example: '七月望日', source: '《水浒传》', allusion: '望日月亮圆满，中秋赏月即八月望日' },
  { word: '晦', classicalMeaning: '农历每月末', modernEquivalent: '月末', example: '晦朔', source: '《庄子》', allusion: '晦为月末无月之夜，朔为月初' },
  { word: '江', classicalMeaning: '专指长江', modernEquivalent: '长江', example: '江东子弟', source: '《史记·项羽本纪》', allusion: '古"江"专指长江，"河"专指黄河' },
  { word: '河', classicalMeaning: '专指黄河', modernEquivalent: '黄河', example: '河伯', source: '《庄子》', allusion: '古"河"专指黄河，其他河流称"水"（如渭水、汉水）' },
  { word: '敕', classicalMeaning: '皇帝诏令', modernEquivalent: '圣旨/命令', example: '敕造', source: '《红楼梦》', allusion: '敕令为皇帝专用文书，"敕造"即奉旨建造' },
  { word: '钦', classicalMeaning: '皇帝相关/敬辞', modernEquivalent: '御用/尊崇', example: '钦此钦遵', source: '《清史稿》', allusion: '钦字加于皇帝一切行为前：钦定、钦差、钦赐' },
  { word: '嘉', classicalMeaning: '美好/赞许', modernEquivalent: '美好/夸奖', example: '嘉言懿行', source: '《尚书》', allusion: '嘉礼为五礼之一，含冠婚宴饮等吉庆之事' },
  { word: '秩', classicalMeaning: '官阶/俸禄/秩序', modernEquivalent: '级别/秩序', example: '秩满', source: '《汉书》', allusion: '"秩"既指官员级别（秩二千石），也指任期届满（秩满）' },
  { word: '致仕', classicalMeaning: '退休还禄', modernEquivalent: '退休', example: '致仕归乡', source: '《礼记》', allusion: '古代官员七十致仕（退休），将禄位还给君主' },
  { word: '丁忧', classicalMeaning: '父母丧期守制', modernEquivalent: '服丧', example: '丁忧三年', source: '《晋书》', allusion: '父母去世后子女须守丧三年（实为二十七月），不得任官' },
];
