...
export const DRAMA_MAPPINGS: DramaMapping[] = [
  ...
  },
  {
    ...
    factCheckSummaries: [
      {
        dramaClaim: '项羽在鸿门宴上被樊哙怒斥后退缩',
        historicalFact: '《史记》记载项羽当时以礼待客，樊哙闯入护主，项羽并未退缩，而是赐酒肉',
        nature: 'exaggeration',
        explanation: '戏剧强化项羽的优柔寡断，实际是项羽出于贵族礼节未下杀手',
      },
      {
        dramaClaim: '韩信受胯下之辱后立刻被刘邦重用',
        historicalFact: '韩信先投项羽未受重用，再投刘邦，最初仅任连敖，经萧何月下追回后才拜大将',
        nature: 'omission',
        explanation: '戏剧压缩时间线，省略韩信早期的求职波折',
      },
    ],
  ...
  },
  {
    ...
    factCheckSummaries: [
      {
        dramaClaim: '康熙少年时智擒鳌拜是独自策划',
        historicalFact: '《清史稿》记载康熙召索额图等近臣共同谋划，并以"布库戏"少年亲信执行',
        nature: 'exaggeration',
        explanation: '戏剧突出少年天子英明，实际是集体决策',
      },
      {
        dramaClaim: '康熙平三藩时亲自统军南征',
        historicalFact: '康熙始终坐镇北京调度，前线主帅先后为勒尔锦、图海、赵良栋等',
        nature: 'fiction',
        explanation: '戏剧把战功集中于主角，与史实不符',
      },
    ],
  ...
  },
  {
    ...
    factCheckSummaries: [
      {
        dramaClaim: '雍正篡改遗诏"传位十四子"为"传位于四子"',
        historicalFact: '清代遗诏用满汉蒙三种文字书写，汉字"十"改"于"在满文中无法对应',
        nature: 'fiction',
        explanation: '民间传说，已被史学界否定，但戏剧仍沿用制造冲突',
      },
      {
        dramaClaim: '雍正被吕四娘刺杀于圆明园',
        historicalFact: '《清实录》记载雍正病逝于雍正十三年八月二十三日，无刺杀记录',
        nature: 'fiction',
        explanation: '野史演绎，戏剧为增加戏剧性采用',
      },
      {
        dramaClaim: '雍正残酷迫害兄弟圈禁至死',
        historicalFact: '雍正确实圈禁胤禩胤禟并改其名，但二人死于禁所，未亲赐死',
        nature: 'exaggeration',
        explanation: '戏剧强化雍正刻薄形象，实际处置有政治考量',
      },
    ],
    audiobookChapterIds: ['ch-qing'],
    watchOrder: 10,
  ...
  },
  {
    ...
    factCheckSummaries: [
      {
        dramaClaim: '白鹿原上的家族恩怨跨越清末到建国整整五十年',
        historicalFact: '小说原作设定为清末到 1949 年，剧中有所压缩，部分事件时间重叠',
        nature: 'omission',
        explanation: '电视剧为节奏需要合并年代，与小说原作时间线略有出入',
      },
      {
        dramaClaim: '白灵在革命中牺牲于肃反',
        historicalFact: '小说中白灵死于根据地肃反，但具体情节是艺术虚构，无原型对应',
        nature: 'fiction',
        explanation: '陈忠实笔下白灵代表一代理想主义者，情节为文学加工',
      },
    ],
    audiobookChapterIds: [],
    watchOrder: 12,
  },
  {
    ...
    factCheckSummaries: [
      {
        dramaClaim: '孙少平在大西北煤矿当矿工并最终回到煤矿',
        historicalFact: '路遥小说原作中孙少平结局是受伤后回到煤矿继续工作，剧中基本忠于原作',
        nature: 'fiction',
        explanation: '属文学虚构，无史实勘误，但情节为艺术加工',
      },
      {
        dramaClaim: '故事背景设定在 1975-1985 年陕北农村',
        historicalFact: '时间背景与原作一致，反映改革开放初期农村真实困境',
        nature: 'omission',
        explanation: '剧情基本忠实，但部分政策细节被简化',
      },
    ],
    audiobookChapterIds: [],
    watchOrder: 13,
  },
  {
    ...
    factCheckSummaries: [
      {
        dramaClaim: '张小敬在 12 个时辰内拯救长安于危难',
        historicalFact: '张小敬为马伯庸小说虚构人物，但天宝三载上元节的历史背景真实',
        nature: 'fiction',
        explanation: '虚构主角承载真实历史场景，非史实人物',
      },
      {
        dramaClaim: '突厥狼卫潜入长安策划惊天阴谋',
        historicalFact: '天宝三载（744 年）突厥已衰败，主要威胁是回纥和吐蕃，无突厥大规模渗透记录',
        nature: 'exaggeration',
        explanation: '为戏剧张力选择突厥为反派，与当时实际地缘形势不符',
      },
      {
        dramaClaim: '剧中靖安司作为唐代反间谍机构存在',
        historicalFact: '靖安司为小说虚构，唐代有"不良人"和"巡按"等机构但职能不同',
        nature: 'fiction',
        explanation: '架空机构服务于叙事需要',
      },
    ],
    audiobookChapterIds: ['ch-sui-tang'],
    watchOrder: 14,
