...
export const SCENE_CONFIGS: Record<SceneId, CulturalScene> = {
  ...
  'bamboo-slip': {
    ...
    theme: {
      ...
      '--color-accent': '#8b4513',
      '--bg-pattern':
        'repeating-linear-gradient(90deg, transparent 0px, transparent 28px, rgba(61,40,23,0.08) 28px, rgba(61,40,23,0.08) 30px), repeating-linear-gradient(0deg, transparent 0px, transparent 80px, rgba(61,40,23,0.06) 80px, rgba(61,40,23,0.06) 82px)',
  ...
  'silk-scroll': {
    ...
    theme: {
      ...
      '--color-accent': '#1e5b8e',
      '--bg-pattern':
        'linear-gradient(135deg, rgba(30,91,142,0.04) 0%, transparent 50%, rgba(184,148,29,0.04) 100%)',
  ...
  'porcelain': {
    ...
    theme: {
      ...
      '--color-accent': '#5a8a7a',
      '--bg-pattern':
        'radial-gradient(circle at 25% 25%, rgba(90,138,122,0.06) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(200,216,210,0.1) 0%, transparent 50%)',
  ...
  'bronze': {
    ...
    theme: {
      ...
      '--color-accent': '#7a8b3e',
      '--bg-pattern':
        'radial-gradient(ellipse at top, rgba(122,139,62,0.08) 0%, transparent 60%), radial-gradient(ellipse at bottom, rgba(201,184,154,0.04) 0%, transparent 60%)',
  ...
  'seal': {
    ...
    theme: {
      ...
      '--color-accent': '#c23b22',
      '--bg-pattern':
        'radial-gradient(circle at 30% 30%, rgba(194,59,34,0.05) 0%, transparent 40%), radial-gradient(circle at 70% 70%, rgba(139,0,0,0.04) 0%, transparent 40%)',
