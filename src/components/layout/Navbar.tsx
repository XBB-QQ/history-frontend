...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { label: '汉字', path: '/char-evolution' },
    { label: '食谱', path: '/dynasty-food' },
    ...
    { label: '辩论', path: '/cross-debate' },
    { label: '史官', path: '/ai-historian' },
    { label: '视角', path: '/multi-perspective' },
    { label: '注解', path: '/classical-annotation' },
    { label: '沙盘', path: '/dynasty-economy' },
    { label: '战役', path: '/battle' },
    { label: '水墨', path: '/ink-animation' },
    { label: '疆域', path: '/territory' },
    { label: '地图', path: '/map' },
